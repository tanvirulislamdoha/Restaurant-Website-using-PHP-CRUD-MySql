    ...
    <!-- <div class="row justify-content-center mt-5">
      ...
      <div class="row justify-content-center mt-5">
        <div class="col-lg-4 col-md-6 col-sm-12">
          ...
          <form action="cUpdateCheck.php" method="post" enctype="multipart/form-data">
              <div class="mb-3">
                <h4 class="text-center p-2">Update Product</h4>
              </div>
              <div class="mb-3">
                  Product Name:
                  <input type="text" class="form-control" name="prodname" value="<?php echo $data['prodname'] ?>">
              </div>
              <div class="mb-3">
                  Price:
              ...
              <button type="submit" class="btn btn-secondary col-12" name="submit">Update</button>
        </form>
